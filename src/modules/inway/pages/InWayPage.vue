<template>
  <section class="page space-y-4">
    ...
    <div v-if="query.isLoading.value" class="rounded-2xl border border-dashed p-6 text-slate-500">Загрузка данных...</div>
    <div v-else-if="query.error.value" class="rounded-2xl border border-red-200 bg-red-50 p-6 text-red-700">Не удалось загрузить список товаров в пути.</div>
